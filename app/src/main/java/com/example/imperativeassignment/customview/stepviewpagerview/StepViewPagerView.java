package com.example.imperativeassignment.customview.stepviewpagerview;
...
public class StepViewPagerView extends View {
    ...
    private Drawable selectedCircle = getResources().getDrawable(R.drawable.ic_step_completed_tick);
    private Drawable notSelectedCircle = getResources().getDrawable(R.drawable.ic_step_incompleted_tick);

    private Rect bounds = new Rect();

    public StepViewPagerView(Context context) {
        this(context, null);
    }

    public StepViewPagerView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.sv_stepViewStyle);
    }

    public StepViewPagerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void applyStyles(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.StepView, defStyleAttr, R.style.StepHobNobViewPagerViewStyle);
...
//                drawNumber(canvas, number, circleCenterX, paint);
    ...
    private void drawLine(Canvas canvas, int startX, int endX, int centerY, boolean highlight) {
        if (highlight) {
            ...
            paint.setStrokeWidth(stepLineWidth/2);
    ...
    public class State {
        ...
        @AnimationType
        private int animationType = StepViewPagerView.this.animationType;
        @ColorInt
        private int selectedCircleColor = StepViewPagerView.this.selectedCircleColor;
        @Dimension
        private int selectedCircleRadius = StepViewPagerView.this.selectedCircleRadius;
        @ColorInt
        private int selectedTextColor = StepViewPagerView.this.selectedTextColor;
        @ColorInt
        private int doneCircleColor = StepViewPagerView.this.doneCircleColor;
        @Dimension
        private int doneCircleRadius = StepViewPagerView.this.doneCircleRadius;
        @ColorInt
        private int doneTextColor = StepViewPagerView.this.doneTextColor;
        @ColorInt
        private int nextTextColor = StepViewPagerView.this.nextTextColor;
        @Dimension
        private int stepPadding = StepViewPagerView.this.stepPadding;
        @ColorInt
        private int nextStepLineColor = StepViewPagerView.this.nextStepLineColor;
        @ColorInt
        private int doneStepLineColor = StepViewPagerView.this.doneStepLineColor;
        @Dimension
        private int stepLineWidth = StepViewPagerView.this.stepLineWidth;
        @Dimension(unit = Dimension.SP)
        private float textSize = StepViewPagerView.this.textSize;
        @Dimension
        private int textPadding = StepViewPagerView.this.textPadding;
        @ColorInt
        private int selectedStepNumberColor = StepViewPagerView.this.selectedStepNumberColor;
        @Dimension(unit = Dimension.SP)
        private float stepNumberTextSize = StepViewPagerView.this.stepNumberTextSize;
        @ColorInt
        private int doneStepMarkColor = StepViewPagerView.this.doneStepMarkColor;
        private int animationDuration = StepViewPagerView.this.animationDuration;
        private boolean nextStepCircleEnabled = StepViewPagerView.this.nextStepCircleEnabled;
        @ColorInt
        private int nextStepCircleColor = StepViewPagerView.this.nextStepCircleColor;
        ...
        public void commit() {
            StepViewPagerView.this.animationType = animationType;
            StepViewPagerView.this.selectedTextColor = selectedTextColor;
            StepViewPagerView.this.selectedCircleRadius = selectedCircleRadius;
            StepViewPagerView.this.selectedCircleColor = selectedCircleColor;
            StepViewPagerView.this.doneCircleColor = doneCircleColor;
            StepViewPagerView.this.doneCircleRadius = doneCircleRadius;
            StepViewPagerView.this.doneTextColor = doneTextColor;
            StepViewPagerView.this.nextTextColor = nextTextColor;
            StepViewPagerView.this.stepPadding = stepPadding;
            StepViewPagerView.this.nextStepLineColor = nextStepLineColor;
            StepViewPagerView.this.doneStepLineColor = doneStepLineColor;
            StepViewPagerView.this.stepLineWidth = stepLineWidth;
            StepViewPagerView.this.textSize = textSize;
            StepViewPagerView.this.textPadding = textPadding;
            StepViewPagerView.this.selectedStepNumberColor = selectedStepNumberColor;
            StepViewPagerView.this.stepNumberTextSize = stepNumberTextSize;
            StepViewPagerView.this.doneStepMarkColor = doneStepMarkColor;
            StepViewPagerView.this.animationDuration = animationDuration;
            setTypeface(typeface);
            StepViewPagerView.this.nextStepCircleEnabled = nextStepCircleEnabled;
            StepViewPagerView.this.nextStepCircleColor = nextStepCircleColor;
            if (steps != null && !StepViewPagerView.this.steps.equals(steps)) {
                StepViewPagerView.this.setSteps(steps);
            } else if (stepsNumber != 0 && stepsNumber != StepViewPagerView.this.stepsNumber) {
                StepViewPagerView.this.setStepsNumber(stepsNumber);
            } else {
                StepViewPagerView.this.invalidate();
            }
        }
    }
}
